...
const KEYWORD_DESC = 'CHANGE 이벤트 전용 키워드 (예: 리그 오브 레전드)';
...
const commands = [
  ...
  new SlashCommandBuilder()
    .setName('subscribe')
    .setDescription('이벤트 구독 - 예: /subscribe CHANGE 리그 오브 레전드')
  ...
  new SlashCommandBuilder()
    .setName('unsubscribe')
    .setDescription('구독 해제 - 예: /unsubscribe CHANGE 리그 오브 레전드')
    .addStringOption(option =>
      option.setName('event')
        .setDescription(EVENT_DESC)
        .setRequired(false)
  ...
  new SlashCommandBuilder()
    ...
    .setDescription('구독 목록 조회 - 예: /subscriptions CHANGE 리그 오브 레전드')
    .addStringOption(option =>
      option.setName('event')
        .setDescription(EVENT_DESC)
        .setRequired(false)
